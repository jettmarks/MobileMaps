 ...
 * the License.
 */
package com.jettmarks.bikeTrains.client.activities.animationdone;
...
public class AnimationDissolvePlace extends Place {
	public static class AnimationDissolvePlaceTokenizer implements
			PlaceTokenizer<AnimationDissolvePlace> {
