...
public interface PopupView extends DetailView {
	...
	public void confirmSomeStuff(String title, String text,
			ConfirmCallback callback);

	public void showSomeOptions(
			List<OptionsDialogEntry> optionText,
			com.googlecode.mgwt.ui.client.widget.dialog.Dialogs.OptionCallback callback);
}
