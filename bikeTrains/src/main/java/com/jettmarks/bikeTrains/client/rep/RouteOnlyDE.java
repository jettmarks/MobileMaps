...
/**
 * Holds a Route which doesn't have a record in the database, but only exists on
 * the Local Drive as a GPX file.
 * 
 ...
 * @author jett
 */
public class RouteOnlyDE extends DisplayElementDTO implements Serializable,
		IsSerializable {
	/**
   * 
   */
