...
/**
 * How to get a list of DisplayElements for a given DisplayGroup and then
 * instances matching the particular subclass (Bike Train or
 * SuitabilitySegment).
 * 
 * This handles
 * <UL>
 ...
 * <LI>Obtaining the SuitabilitySegmentDE that matches a particular
 * DisplayElement.
 * </UL>
 * 
 * At this time, the caller must know which displayGroups will return one type
 * of DisplayElement so it can be used to retrieve the proper subclassed object.
 *
 * @author jett
 */
