 ...
 * the License.
 */
package com.jettmarks.bikeTrains.client.activities.scrollwidget;
...
public class ScrollWidgetPlace extends Place {
	public static class ScrollWidgetPlaceTokenizer implements
			PlaceTokenizer<ScrollWidgetPlace> {
