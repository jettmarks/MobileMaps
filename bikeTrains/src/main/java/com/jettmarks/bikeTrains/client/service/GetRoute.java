 ...
 * EncodedTrack, otherwise the default name space is used. The default name
 * space can be overridden by using the ManageProperties interface.
 * 
 * The RouteSourceName isn't fully implemented, but should normally be given as
 * "Local Drive" for implementations where the resource is on the local hard
