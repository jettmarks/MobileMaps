 ...
 * particularly local drive directory(tag), but some will also persist the route
 * as a BikeTrain or a rated segment.
 * 
 * @author jett
 * 
 */
...
public interface RouteSave extends RemoteService {
	...
	public int saveBikeTrain(String fileResource, String fileContents,
