 ...
 * the License.
 */
package com.jettmarks.bikeTrains.client.activities.popup;
...
public class PopupActivity extends DetailActivity {
	...
	public void start(AcceptsOneWidget panel, EventBus eventBus) {
		...
		addHandlerRegistration(view.getConfirmButton().addTapHandler(
				new TapHandler() {

					@Override
					public void onTap(TapEvent event) {
						view.confirmSomeStuff("Confirm this",
								"Confirm some more stuff",
								new ConfirmCallback() {
		...
		addHandlerRegistration(view.getSlideUpButton().addTapHandler(
				new TapHandler() {

					@Override
					public void onTap(TapEvent event) {
						List<OptionsDialogEntry> list = new ArrayList<OptionsDialogEntry>();
						list.add(new OptionsDialogEntry("Confirm",
								ButtonType.CONFIRM));
						list.add(new OptionsDialogEntry("Cancel",
								ButtonType.NORMAL));
						list.add(new OptionsDialogEntry("Delete",
		...
		addHandlerRegistration(view.getAlertButton().addTapHandler(
				new TapHandler() {
