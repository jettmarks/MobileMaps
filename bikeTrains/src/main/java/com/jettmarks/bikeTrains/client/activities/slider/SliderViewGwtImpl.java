 ...
 * the License.
 */
package com.jettmarks.bikeTrains.client.activities.slider;
...
public class SliderViewGwtImpl extends DetailViewGwtImpl implements SliderView {
	...
	public SliderViewGwtImpl() {
		...
		valueField.getElement().setAttribute("style",
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.googlecode.mgwt.examples.showcase.client.activities.SliderView#
	 * getTextField()
	 */
	@Override
