...
import com.jettmarks.auth.FBAuth;
import com.jettmarks.auth.User;
...
public class HibernateUtil {
   ...
   */
	...
	connectionPoolProperties.put("hibernate.connection.provider_class",
   ...
   */
	...
	// Auth tables
	cfg.addAnnotatedClass(FBAuth.class).addAnnotatedClass(User.class);
    }
