...
public interface RouteSaveAsync
{
  ...
  public void saveAs(String fileResource, String fileContents, AsyncCallback<Integer> callback);
  /** Save route contents as named file under specified tagList. */
  public void saveAs(String fileResource, 
		  String[] tagList, 
		  String fileContents, 
