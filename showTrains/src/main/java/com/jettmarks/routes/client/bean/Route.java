...
public class Route {
	...
	protected PolylineOptions unselectedStyleOptions = PolylineOptions
			.newInstance();

	protected PolylineOptions highlightedStyleOptions = PolylineOptions
			.newInstance();
	...
	public void setPoints(LatLng[] points, String color) {
		...
		// Don't bother with putting on the map if we don't have one (save w/o
		// disp)
	...
	public void highlight(boolean on) {
		...
		if (on) {
			highlightedPolyline.setVisible(true);
			polyline.setVisible(false);
		} else {
			polyline.setVisible(true);
			highlightedPolyline.setVisible(false);
		}
	}
