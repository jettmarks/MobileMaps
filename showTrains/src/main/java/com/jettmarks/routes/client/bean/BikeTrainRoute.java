...
public class BikeTrainRoute extends DisplayOnlyRoute
{
  ...
  protected InfoWindowContent createInfoBubbleContent()
  {
    ...
    String dStr = temp.substring(0, temp.indexOf('.')+3);
    if (infoContent == null)
    {
      initInfoContent(dStr);
    }
  ...
  protected void initInfoContent(String dStr)
  {
    ...
    infoContent.append(
        ...
        "<BR>Distance: " + dStr +
        "<BR>Departs: " + bikeTrain.getDepartureTime());
    ...
    {
      infoContent.append("<BR>Leader Phone: " + bikeTrain.getLeaderPhone());
    }
  ...
  private void addRWGPSCueSheet()
  {
    ...
    infoContent.append( "<BR><a href=\""+baseUrl
        + "/cue_sheet"
        + "\" target=\"_blank\""
  ...
  {
    infoContent.append( "<BR><a href=\"http://www.bikely.com/cuesheet/route/" 
        + name
        + "\" target=\"_blank\""
        + ">Cue Sheet</a> (and waypoints if any)");
  }
