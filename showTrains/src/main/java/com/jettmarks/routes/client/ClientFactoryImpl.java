...
import com.jettmarks.routes.client.ui.RouteSelectedViewGwtImpl;
...
public class ClientFactoryImpl implements ClientFactory {
	...
	private RouteSelectedView routeSelectedView;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.jettmarks.routes.client.ClientFactory#getRouteSelectedView()
	 */
	@Override
	public RouteSelectedView getRouteSelectedView() {
		if (routeSelectedView == null) {
			routeSelectedView = new RouteSelectedViewGwtImpl();
		}
		return routeSelectedView;
	}
