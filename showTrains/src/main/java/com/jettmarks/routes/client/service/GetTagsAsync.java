...
public interface GetTagsAsync
{
   ...
   * @see com.jettmarks.routes.client.service.GetTags
   */
  void getTagList( java.lang.String token, AsyncCallback<java.lang.String[]> callback );
...
//        target.setServiceEntryPoint( GWT.getModuleBaseURL() + "../getTags" );
  ...
  void saveDisplayGroup(String description,
