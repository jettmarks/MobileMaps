...
public class EventViewTabbedGwtImpl extends MapDetailViewGwtImpl implements
	...
	public EventViewTabbedGwtImpl() {
		...
		listWidget = new CellList<Route>(new RouteCell());
   ...
   */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.jettmarks.routes.client.ui.EventView#getCellList()
	 */
	@Override
	public HasCellSelectedHandler getRouteList() {
		return listWidget;
	}

	/**
	 * Given the index into the list of routes, return the one matching.
	 * 
	 * @see com.jettmarks.routes.client.ui.EventView#getSelectedRoute(int)
	 */
	@Override
	public Route getSelectedRoute(int index) {
	...
	public void enableBackButton(boolean isEnabled) {
		headerBackButton.setVisible(isEnabled);
	}
