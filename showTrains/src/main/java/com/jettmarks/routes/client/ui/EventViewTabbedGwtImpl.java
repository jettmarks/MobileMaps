                                                                ...
                                                                EventView
{
   ...
   * 
   * This is responsible for responding to the changes of selection performed on
   * the list tab. This should probably be moved out to the activity.
   * 
   * @return
   */
  private CellList<Route> prepareList()
  {
    ...
    cellList.addCellSelectedHandler(new CellSelectedHandler()
    {
      ...
      public void onCellSelected(CellSelectedEvent event)
      {
        ...
        BikeTrainRoute previouslySelectedRoute = (BikeTrainRoute) rc.getSelectedRoute();
